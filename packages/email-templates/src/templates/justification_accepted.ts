export function justification_accepted({
  mainColor,
  headerTextColor,
  name,
  siteLink,
  ...
  return `<!doctype html>
    <html lang="pt-br">
      <head>
        ...
        <title>Ausência Justificada</title>
        <style>
          body {
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-content">
            ...
            <p>
              Sua justificativa de ausência no ${eventName} foi aceita. Agradecemos por ter enviado a justificativa e esperamos que você possa participar do próximo evento.
            </p>
