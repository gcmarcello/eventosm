export function added_to_team_signup({
  mainColor,
  headerTextColor,
  name,
  siteLink,
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-content">
            ...
            <p>
              Você foi adicionado por ${ownerName}. Para confirmar sua conta e ter acesso ao perfil, por favor clique no botão abaixo.
            </p>
