...
import { For } from "../../_shared/components/For";
...
const navigation = [
  ...
  { name: "Transparência", href: "#", current: false },
  { name: "Notícias", href: "#", current: false },
  ...
  return (
    <>
      <div className="min-h-full">
        <Disclosure as="nav" className="bg-emerald-500 shadow-sm">
          {({ open }) => (
            <>
                ...
                <div className="flex h-20 justify-between">
                  <div className="flex">
                    <div className="flex flex-shrink-0 items-center">
                      <Logo url="/logo_cbmtb.png" size={128} />
                    </div>
