    ...
    <>
      <div className="absolute w-64 overflow-clip shadow-lg">
            ...
            <div className="fixed inset-0 flex">
              ...
              >
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div
                    className={clsx(
                      "fixed flex h-full w-64 grow flex-col gap-y-5 overflow-y-auto bg-indigo-600 px-6 py-4 pb-4"
                    )}
                  >
        ...
        <div className="hidden lg:flex lg:h-screen lg:w-64 lg:flex-col">
          <div
            className={clsx(
              `fixed flex h-full w-64 grow  flex-col gap-y-1 overflow-y-hidden bg-indigo-600 px-6 py-4 pb-4`
            )}
          >
