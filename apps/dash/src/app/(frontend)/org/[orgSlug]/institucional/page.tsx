...
export default async function InstitutionalPage({
  ...
  return (
    <div className="mx-auto max-w-7xl rounded-b-md bg-white px-4 pt-10 lg:gap-x-8 lg:px-8">
      ...
      <div className="my-2 space-y-2 text-sm">
        <Text>
          ...
          regulamentos, atas de reuniões e outros documentos importantes. Também
        ...
        <Text className="hidden lg:block">
          ...
          de auditoria, para que nossos membros possam acompanhar o desempenho
