      ...
      <div className="mx-auto max-w-7xl rounded-b-md bg-white px-4  pt-8 lg:gap-x-8 lg:px-8">
        ...
        <div className="my-2 space-y-2 text-sm">
          <Text>
            ...
            Também fornecemos informações sobre nossa estrutura organizacional,
            incluindo os membros de nosso conselho e equipe administrativa.
          </Text>
          <Text className="hidden lg:block">
            ...
            nossos balanços financeiros, demonstrações de resultados e
            relatórios de auditoria, para que nossos membros possam acompanhar o
            desempenho financeiro de nossa entidade. Estamos comprometidos em
            manter um alto nível de integridade e ética em nossas operações.
          </Text>
          <Text className="hidden lg:block">
