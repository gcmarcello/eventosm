  ...
  return (
    <>
      <div className="bg-slate-200 ">
        <div className="pb-20">
          <div
            className={clsx("rounded-b-md bg-white pb-4 xl:mx-16 2xl:mx-72")}
          >
            ...
            <div className="mt-4 grid grid-cols-6 gap-4 px-4">
              <div className="xxl:col-span-1 col-span-6 md:col-span-2">
              ...
              <div className="xxl:col-span-5 col-span-6 flex-col md:col-span-4 md:flex">
                <NewsCard news={news} />
              </div>
            </div>
          </div>
